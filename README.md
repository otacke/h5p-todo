...
- [ ] **H5P editor core:** _[Feature]_ H5P-3599 Allow to retrieve configuration of list widget ([pull request](https://github.com/h5p/h5p-editor-php-library/pull/164))
...
- [ ] **VerticalTabs:** _[Feature]_ H5P-3599 Hide buttons based on min/max setting ([pull request](https://github.com/h5p/h5p-editor-vertical-tabs/pull/3))
...
- [ ] **Accordion:** _[Fix]_ Fix word-wrap in button ([pull request](https://github.com/h5p/h5p-accordion/pull/74))
...
- [ ] **Image:** _[Fix]_ Fix alt and title attribute ([pull request](https://github.com/h5p/h5p-image/pull/55))
