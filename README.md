...
- **Multimedia Choice:** _[Fix]_ Fix lowercase in library title ([pull request](https://github.com/h5p/h5p-multi-media-choice/pull/8))
- **Multimedia Choice:** _[Fix]_ Fix media type detection ([pull request](https://github.com/h5p/h5p-multi-media-choice/pull/5))
