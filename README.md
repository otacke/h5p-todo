...
- [ ] **H5P CLI:** _[Fix]_ HFP-3901 Add mission fileIcon definition ([pull request](https://github.com/h5p/h5p-cli/pull/76))
...
- [ ] **Audio:** _[Fix]_ HFP-3826 Add icon ([pull request](https://github.com/h5p/h5p-audio/pull/93))
