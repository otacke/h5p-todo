...
- [ ] **Drag and Drop:** _[Feature]_ Add audio on drag and drop ([pull request](https://github.com/h5p/h5p-drag-question/pull/92)) ![merge-conflict](https://img.icons8.com/color/18/conflict.png)
...
- [ ] **Flashcards:** _[Feature]_ Add option to randomize cards ([pull request](https://github.com/h5p/h5p-flashcards/pull/17)) ![merge-conflict](https://img.icons8.com/color/18/conflict.png)
- [ ] **Flashcards:** _[Feature]_ Add option to use alternative solutions separated by | ([pull request](https://github.com/h5p/h5p-flashcards/pull/43)) ![merge-conflict](https://img.icons8.com/color/18/conflict.png)
...
- [ ] **Flashcards:** _[Feature]_ Add optional audio button ([pull request](https://github.com/h5p/h5p-flashcards/pull/64)) ![merge-conflict](https://img.icons8.com/color/18/conflict.png)
...
- [ ] **Interactive Video:** _[Feature]_ Allow to add custom audio tracks and sign language videos ([pull request](https://github.com/h5p/h5p-interactive-video/pull/233)) ![merge-conflict](https://img.icons8.com/color/18/conflict.png)
...
- [ ] **Single Choice Set:** _[Fix]_ Stop giving away correct answers in page source ([pull request](https://github.com/h5p/h5p-single-choice-set/pull/53)) ![merge-conflict](https://img.icons8.com/color/18/conflict.png)
