...
- [ ] **H5P CLI:** _[Fix]: HFP-4350 Add missing custom CSS props for theming ([pull request](https://github.com/h5p/h5p-cli/pull/181))
- [ ] **H5P CLI:** _[Fix]: HFP-4354 Fix trying to access shortname of unregistered library ([pull_request](https://github.com/h5p/h5p-cli/pull/183))
...
- [x] **Registry:** _[Fix]_ HFP-4155 Add KewArCode editor widget ([pul request](https://github.com/h5p/h5p-registry/pull/9))
- [x] **Registry:** _[Fix]_ Add H5P.RowColumn ([pull request](https://github.com/h5p/h5p-registry/pull/10))
...
- [x] **Drag the Words:** _[Fix]_ HFP-3847 Improve draggable handling accessibility ([pull request](https://github.com/h5p/h5p-drag-text/pull/149))
...
- [x] **Image Hotspots:** _[Fix]_ HFP-4077 Improve CSS specificity ([pull request](https://github.com/h5p/h5p-image-hotspots/pull/115))
- [ ] **Image Hotspots:** _[Fix]_ HFP-4254 Fix setTitle for image buttons ([pull request](https://github.com/h5p/h5p-image-hotspots/pull/125))
- [ ] **Image Hotspots:** _[Feature]_ HFP-4256 Allow author to add a custom icon image to each hotspot ([pull request](https://github.com/h5p/h5p-image-hotspots/pull/126))
- [ ] **Image Hotspots:** _[Feature]_ HFP-4257 Allow author to choose "consecutive numbering" for hotspots ([pull request]())
...
- [x] **Video** _[Feature]_ HFP-4174 Allow Panopto videos to be used from self-hosted Panopto instanced ([pull request](https://github.com/h5p/h5p-video/pull/148))
...
H5P features a PHP based library named [h5p-php-report](https://github.com/h5p/h5p-php-report) that allows to interpret the results of H5P exercises (essentially amended excerpts of xAPI statements) and to display them. That library is not maintained well anymore. Also, being PHP based limits its use for ports of H5P, e. g. the node.js port.
Idea: Create a JavaScript based reinterpretation to be used flexibly by any H5P integration or Learning Record Store or even as a service with a standalone solution
- render H5P's results (return values of getXAPIData()) directly or parameters passed to php-h5p-library or mere xAPI results from other sources
