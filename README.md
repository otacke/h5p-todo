...
- [ ] **H5P CLI:** _[Fix]_ Add missing file type checking ([pull request](https://github.com/h5p/h5p-cli/pull/92))
- [ ] **H5P CLI:** _[Fix]_ Fix resetting state after content changed ([pull request](https://github.com/h5p/h5p-cli/pull/96))
- [ ] **H5P CLI:** _[Feature]_ Add reset button for sessions ([pull request](https://github.com/h5p/h5p-cli/pull/97))
- [ ] **H5P CLI:** _[Feature]_ Add support for user configuration file ([pull request](https://github.com/h5p/h5p-cli/pull/98))
...
- [ ] **H5P core:** _[Feature]_ Add reduced motion mode to confirmation dialog ([pull request](HFP-3815 https://github.com/h5p/h5p-php-library/pull/160))
...
- [ ] **Course Presentation:** _[Fix]__ HFP-3825 Do not send xAPI completed on resume ([pull request](https://github.com/h5p/h5p-course-presentation/pull/286))
- [ ] **Course Presentation:** _[Fix]__ HFP-3918 Fix small bugs with GoToSlide ([pull request](https://github.com/h5p/h5p-course-presentation/pull/303))
